...
class newReport implements Report{
	...
	public String getReportContent() {
		return "got report's content";
	}
	
}
public class ReportGenerator implements creator{
	...
	public Report generateReport(ReportData data, String type) { //from creator
